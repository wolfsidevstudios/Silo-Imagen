...
const Section: React.FC<{children: React.ReactNode, className?: string}> = ({ children, className }) => (
    <section className={`w-full max-w-5xl px-4 py-16 sm:py-24 animate-fade-in-slow ${className || ''}`}>
        {children}
    </section>
);
...
export const LandingPage: React.FC<LandingPageProps> = ({ onStart }) => {
  return (
    <div className="w-full flex flex-col items-center">
      ...
      {/* --- Hero Section --- */}
      <header className="text-center flex flex-col items-center gap-8 pt-24 pb-16 sm:pt-32 sm:pb-24 min-h-[60vh] justify-center">
